...
<body>
                        ...
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav">
                                ...
                                <ul>
                                    ...
                                    <li><a href="trang-chinh/tin-tuc.php">Blog</a></li>
    ...
    <div style="width: 100%; ">
        <a href="#"><img src="assets/img_nike_sneakers/banner.jpg" width="100%"></a>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                        <div class="item">
                            <a href="./trang-chinh/chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img style="width: 200px" src="../../bigshoes/css/admin/images/products/<?= $hinh ?>" alt="ds"></a>
                        </div>
                    <?php } ?>
    ...
    <div class="container-fluid now" style="margin-top: 80px;">
        <div class="row ">
            <div class="col-md-6">
                <div class="jus">
                    <img src="../bigshoes/css/trang-chu/img/nike-by-you-custom-shoes (1).jpg" alt="a">
                </div>
            </div>
            <div class="col-md-6">
                <div class="newjus">
                    <ul>
                        ...
                        <li>
                            <a href="./trang-chinh/danh-sach-sp.php">XEM NGAY</a>
                        </li>
                    </ul>
                </div>
            </div>
